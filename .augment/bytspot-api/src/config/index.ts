...
const envSchema = z.object({
  ...
  STRIPE_SECURE_HOLD_PAYMENT_METHOD_CONFIGURATION_ID:z.string().default(''),
...
export const config = {
  ...
  stripeSecureHoldPaymentMethodConfigurationId: env.STRIPE_SECURE_HOLD_PAYMENT_METHOD_CONFIGURATION_ID,
