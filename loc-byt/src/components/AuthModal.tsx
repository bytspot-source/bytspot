          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              <motion.div className="mt-3" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  variant="outline"
                  className="w-full glass-effect border-white/30 text-white hover:bg-white/15 backdrop-blur-enhanced rounded-xl touch-feedback interactive-hover"
                  onClick={() => {
                    setPhoneMode(true);
                    setPhoneStep("enter");
                  }}
>
              ...
              {phoneMode && (
                <div className="mt-4 space-y-3">
                  {phoneStep === 'enter' && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        type="tel"
                        inputMode="tel"
                        placeholder="e.g. +1 415 555 0131"
                        value={phone}
                        onChange={(e) => setPhone(e.target.value)}
                        className="glass-effect border-white/30 text-white placeholder-white/60 rounded-xl"
                      />
                  ...
                  {phoneStep === 'code' && (
                    <div className="space-y-2">
                      <Label htmlFor="otp" className="text-white/90 font-medium">Verification code</Label>
                      <Input
                        id="otp"
                        type="text"
                        inputMode="numeric"
                        ...
                        className="glass-effect border-white/30 text-white placeholder-white/60 rounded-xl tracking-widest text-center"
                      />
                      <div className="flex gap-2">
                        <Button
                          className="flex-1 btn-primary rounded-xl"
                          onClick={() => {
                            if (otp.length === 6) {
                              onAuth({ email: `sms:${phone}`, name: `+${phone}` });
                            }
                          }}
                        >
                          Verify & Continue
