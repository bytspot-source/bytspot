...
-- Dated to when it merges, not when it was written. A migration that sorts
-- before ones already applied is a replay hazard on an existing database.
ALTER TABLE "users" DROP COLUMN IF EXISTS "vehicles";
